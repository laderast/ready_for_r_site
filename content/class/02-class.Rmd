...
Open the slides in a separate window: <a href="https://ready4r.netlify.com/slides/02-for_loops#1" target="_blank">https://ready4r.netlify.com/slides/02-for_loops#1</a>

```{r echo=FALSE}
knitr::include_url('https://ready4r.netlify.com/slides/02-for_loops#1')
```
